		...
		<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-right">
							<li><a class="hvr-underline-from-center active" href="index.html">Главная</a></li>
							<li><a href="#team" class="hvr-underline-from-center scroll scroll">Сотрудники</a></li>
							...
							<li><a href="#" data-toggle="dropdown"><span data-hover="ShortCodes">Грузоперевозки</span><span class="caret"></span></a>
								<ul class="dropdown-menu">
									<li><a href="icons.html"><span data-hover="Icons">Дачные</span></a></li>
                                    <li><a href="typography.html"><span data-hover="Typograpghy">Квартирные</span></a></li>
                                    <li><a href="typography.html"><span data-hover="Typograpghy">На дальнее растояние</span></a></li>
								</ul>
							</li>	
